...
exports["Queryable: Constructor with query (where: expressionBuilder.and)"] = function () {
    var queryable = new _Queryable2.default();
    queryable = queryable.where(function (expBuilder) {
        return expBuilder.and(expBuilder.property("firstName").isEqualTo("Jared"), expBuilder.property("lastName").isEqualTo("Barnes"));
    });
...
exports["Queryable: Constructor with query (where: expressionBuilder.or)"] = function () {
    var queryable = new _Queryable2.default();
    queryable = queryable.where(function (expBuilder) {
        return expBuilder.or(expBuilder.property("firstName").isEqualTo("Jared"), expBuilder.property("lastName").isEqualTo("Barnes"));
    });
...
exports["Queryable: Check date is still date when refining queryable."] = function () {
    var queryable = new _Queryable2.default("Target").where(function (expBuilder) {
